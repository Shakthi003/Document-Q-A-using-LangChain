...
1. Upload one or more PDF files under **“📄 Upload PDF(s)”**.
2. Click **🛠️ Process documents and (re)build index** to generate embeddings.
3. Enter your question in the text box — the app retrieves and answers from your documents.
